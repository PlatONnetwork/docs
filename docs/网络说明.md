...
If you need to use test LAT on the development network 1, you have to obtain it through the faucet at <https://faucet.platon.network/faucet/>
Development 2 web address: <https://devnet2faucet.platon.network/faucet/>
