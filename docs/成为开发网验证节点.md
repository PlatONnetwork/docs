...
sudo wget https://download.platon.network/platon/devnet/platon/1.1.2/platonkey -P /usr/bin
...
The development network provides a development test environment for the developer or node.There may be instability and a network reset.The current version of the development network is 1.1.2.
