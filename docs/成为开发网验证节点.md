...
> - platon： devnet2：https://download.platon.network/platon/devnet2/platon/1.3.0/platon
> 
> - platonkey： devnet2：https://download.platon.network/platon/devnet2/platon/1.3.0/platonkey
> 
...
```bash
cd ~/platon-node && wget https://download.platon.network/platon/devnet2/platon/1.3.0/genesis.json
```
