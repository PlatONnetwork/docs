...
本教程主要是指导用户在PlatON上使用solidity语言创建简单的HelloWorld智能合约，通过platon-truffle编译，部署，调用此合约。如果您想使用更加丰富的API可以参考[Java SDK开发指南](/Docs/docs/Java_SDK) 或者 [JS SDK开发指南](/Docs/docs/JS_SDK)

- solidity智能合约语法请参考[Solidity官方文档](https://solidity.readthedocs.io/en/develop/)
- 在开发合约前，如果需要搭建私链请参考：[搭建私链](/Docs/docs/Set_Develop_Env#搭建私链)
