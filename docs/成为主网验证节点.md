...
```bash
sudo wget https://download.platon.network/platon/platon/ubuntu20.04/1.4.0/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/ubuntu20.04/1.4.0/platonkey -O /usr/bin/platonkey
```
...
After you execute the platon version, please double check whether your Git Commit value is consistent with the following, if it is consistent, it means that it has been installed correctly:
  ...
  > Git Commit: <font color='red'>a925ade4249284b15e63dcf12edc1559c57115f9</font><br />
