...
```bash
sudo wget https://download.platon.network/platon/platon/1.1.2/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/1.1.2/platonkey -O /usr/bin/platonkey
...
After you execute the platon version, please double check whether your Git Commit value is consistent with the following, if it is consistent, it means that it has been installed correctly:
  ...
  > PlatON<br />
  > Version: 1.1.2-unstable<br />
  > Git Commit: <font color='red'>f0ee9f487c4abee9de032f40641f7f7a6e69bdce</font><br />
  > Architecture: amd64<br />
  > Protocol Versions: [65 63 62]<br />
  > Network Id: 1<br />
  > Go Version: go1.17.4<br />
