...
```bash
sudo wget https://download.platon.network/platon/platon/1.4.1/platon -O /usr/bin/platon
...
After you execute the platon version, please double check whether your Git Commit value is consistent with the following, if it is consistent, it means that it has been installed correctly:
  ...
  > PlatON<br />
  > Version: 1.4.1-unstable<br />
  > Git Commit: <font color='red'>b386fae05d373320f0a6ab5db8ddca3060a510dd</font><br />
  > Git Commit Date: 20230719<br />
  > Architecture: amd64<br />
  > Protocol Versions: [65 63 62]<br />
  > Go Version: go1.18<br />
