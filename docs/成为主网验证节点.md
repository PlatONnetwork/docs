...
```bash
sudo wget https://download.platon.network/platon/platon/1.3.0/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/1.3.0/platonkey -O /usr/bin/platonkey
...
After you execute the platon version, please double check whether your Git Commit value is consistent with the following, if it is consistent, it means that it has been installed correctly:
  ...
  > PlatON<br />
  > Version: 1.3.0-unstable<br />
  > Git Commit: <font color='red'>8ddcea2d05d9b45efb6aa71a1ec49b006c957df3</font><br />
  > Architecture: amd64<br />
  > Protocol Versions: [65 63 62]<br />
  > Go Version: go1.18.3<br />
