...
<font color='red'>The binary in the following command is not available for download until the mainnet is open. Please pay attention to the mainnet launch plan.</font>
