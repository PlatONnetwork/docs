...
> - When  the prompt shows "Please enter the platon chain id:", please  enter the chain ID, and select it according to whether the connected network is the main network or test network (test network: 102).
...
>
> - chainId: The chain of Bailey World is 102.
