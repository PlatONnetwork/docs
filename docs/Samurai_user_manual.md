...
![](/docs/img/en/Samurai.assets/add-chrome.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-welcome.jpg)

2. Click “**Get Started**”,there is two options - **Create wallet** and **iImport wallet**.

![](/docs/img/en/Samurai.assets/samurai-select-action.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-agreement.jpg)

![](/docs/img/en/Samurai.assets/samurai-import-seed.jpg)

![](/docs/img/en/Samurai.assets/samurai-importd.jpg)

![](/docs/img/en/Samurai.assets/samurai-import-home.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-create-password.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-create-seed.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-create-seed-confirm.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-send-address-input.jpg)

+ Enter or select the address for **transfer between my accounts**, and go to the transaction form page.

![](/docs/img/en/Samurai.assets/samurai-send-input.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-add-token.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-add-token-input.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-add-token-confirm.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-token-display.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-assets-list.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-send-token-input.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-send-token-confirm.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-token-tx-detail.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-create-account.jpg)

+ Go to create account form page, enter **account name** (example below is wallet 2), click **create** button.

![](/docs/img/en/Samurai.assets/samurai-home-create-account-input.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-create-accountd.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-import-account.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-import-account-privatekey-input.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-import-accout-keystoret.jpg)
...
![](/docs/img/en/Samurai.assets/samurai-home-import-accountd.jpg)
