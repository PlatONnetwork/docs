...
class Doc extends React.Component {
  ...
  render() {
	...
	let editUrl = this.props.metadata.custom_edit_url; 
	if (this.props.language && this.props.language !== 'en') {
		editUrl = editUrl || ( this.props.config.editUrl && 
		  this.props.config.editUrl + "website/translated_docs/" + this.props.language + "/" + docSource);
	} else if (this.props.language && this.props.language == 'en') {
		editUrl = editUrl ||
		  (this.props.config.editUrl && this.props.config.editUrl + "docs/" + docSource);
	}
