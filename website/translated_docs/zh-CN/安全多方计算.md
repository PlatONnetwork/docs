...
![](/docs/img/zh-CN/MPC.assets/1_out_of_2_ot.png)
...
![](/docs/img/zh-CN/MPC.assets/function_to_boolean_circuit.png)
...
![](/docs/img/zh-CN/MPC.assets/gates_to_true_false_table.jpg)
...
![](/docs/img/zh-CN/MPC.assets/label_to_true_false_table_values.png)
...
![](/docs/img/zh-CN/MPC.assets/choose_random_replace_0_1.jpg)
...
![](/docs/img/zh-CN/MPC.assets/use_input_wire_label_encrypt_output_wire.jpg)
...
![](/docs/img/zh-CN/MPC.assets/gates_decrypt_output_label.jpg)

<center><font size="2">图7: 按门依次解密获得输出标签</font><br /> </center>

## 基本的两方安全计算模式

![](/docs/img/zh-CN/MPC.assets/MPC-basic-flow.png)
...
![](/docs/img/zh-CN/MPC.assets/PlatON_two_parties_infrastructure.png)
