...
<div class="card-wrap">
    ...
    <div class="homepage-card">
        ...
        <a href="/docs/zh-CN/Sol_Smart_Contract" class="card-title">Solidity智能合约开发</a>
        <div class="card-description">
        了解如何开发和使用PlatON区块链Solidity智能合约。
        </div>
    </div>

<div class="homepage-card">
        <img src="/docs/img/Smart_Contract_Development.svg">
        <a href="/docs/zh-CN/WASM_Smart_Contract" class="card-title">WASM智能合约开发</a>
        <div class="card-description">
        了解如何开发和使用PlatON区块链WASM智能合约。
        </div>
    </div>
