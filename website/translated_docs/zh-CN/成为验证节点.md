...
> - nodeName: 节点名称。
> - details: 节点描述信息。
> - externalId: 对应为keybase的账号，PlatScan通过此账号显示为对应的头像；如果用户需要在PlatScan显示指定的头像，可在 [keybase.io](https://keybase.io/) 官网进行注册，然后在keybase上传头像，并将externalId的字段值修改成注册账户，即16位的公钥 。
> - webSite: 公司网址。
