module.exports = {
  docs: [
    ...
    },
    {
      type: 'category',
      label: 'Tutorials',
      items: ['DApp_migrate', 'qianqian_prc721_tutorial', 'WASM_Contract_2', 'WASM_Contract_3', 'WASM_Contract_4', 'WASM_Contract_5', 'WASM_Contract_6', 'WASM_Contract_7', 'WASM_Contract_8', 'walletconnect_tutorial']
