...
```
https://devnetopenapi2.platon.network/rpc 或 ws://devnetopenapi2.platon.network/rpc
https://devnetopenapi.platon.network/rpc 或 ws://devnetopenapi.platon.network/rpc
```
