...
```bash
sudo wget https://download.platon.network/platon/platon/1.1.1/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/1.1.1/platonkey -O /usr/bin/platonkey
...
当您执行完platon version后，请您仔细检查您的Git Commit值是否与下面一致，若一致则表明已经正确安装: 
  ...
  > PlatON<br />
  > Version: 1.1.1-unstable<br />
  > Git Commit: <font color='red'>9960b7fd8128a047bc552b76ab7a0f557d0fb7dd</font><br />
