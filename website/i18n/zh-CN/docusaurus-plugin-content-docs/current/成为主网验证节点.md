...
```bash
sudo wget https://download.platon.network/platon/platon/1.2.1/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/1.2.1/platonkey -O /usr/bin/platonkey
...
当您执行完platon version后，请您仔细检查您的Git Commit值是否与下面一致，若一致则表明已经正确安装: 
  ...
  > PlatON<br />
  > Version: 1.2.1-unstable<br />
  > Git Commit: <font color='red'>890ac8f68cacd82366d369b09240a7ae069c87a1</font><br />
  > Architecture: amd64<br />
  > Protocol Versions: [65 63 62]<br />
  > Network Id: 1<br />
  > Go Version: go1.16.8<br />
