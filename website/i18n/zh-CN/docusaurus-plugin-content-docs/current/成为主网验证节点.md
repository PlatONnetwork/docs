...
```bash
sudo wget https://download.platon.network/platon/platon/1.1.0/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/platon/1.1.0/platonkey -O /usr/bin/platonkey
...
当您执行完platon version后，请您仔细检查您的Git Commit值是否与下面一致，若一致则表明已经正确安装: 
  ...
  > PlatON<br />
  > Version: 1.1.0-unstable<br />
  > Git Commit: <font color='red'>f86c9f8469105ab1969316aefe259b9b5ab3308e</font><br />
  > Architecture: amd64<br />
  > Protocol Versions: [63 62]<br />
  > Network Id: 1<br />
  > Go Version: go1.16.2<br />
  > Operating System: linux<br />
  > GOPATH=<br />
  > GOROOT=/usr/lib/go-1.16<br />
