...
```bash
sudo wget https://download.platon.network/platon/devnet/platon/1.2.1/platon -O /usr/bin/platon
sudo wget https://download.platon.network/platon/devnet/platon/1.2.1/platonkey -O /usr/bin/platonkey
```
...
PlatON开发1网络于北京时间2021年3月10日上线，ChainID：210309。
PlatON开发2网络于北京时间2022年6月13日上线，ChainID：2206131，推荐使用开发2网。
...
开发网为开发者或节点提供开发测试环境。可能出现不稳定，网络重置的情况。开发网络目前版本为1.1.2。

#### 开发网络相关资源

>- platon：1网：https://download.platon.network/platon/devnet/platon/1.2.1/platon 2网：https://download.platon.network/platon/devnet2/platon/1.2.2/platon
>- platonkey：1网：https://download.platon.network/platon/devnet/platon/1.2.1/platonkey 2网：https://download.platon.network/platon/devnet2/platon/1.2.2/platonkey
...
>
>> 需要修改配置文件config.properties中的链ID为开发1网络链ID：210309；开发2网络链ID：2206131
>
>- samurai：
> - 开放RPC URL：http://35.247.155.162:6789 以及 ws://35.247.155.162:6790
>- 开发1网scan浏览器地址：https://devnetscan.platon.network
...
> 提示若在开发网运行mtool，请修改配置文件config.properties中的链ID为开发1网络链ID：210309；开发2网络链ID：2206131。
...
至此，您已成功质押，您可以使用浏览器查看您的节点信息：https://devnetscan.platon.network； 开发2网scan浏览器地址：https://devnet2scan.platon.network
