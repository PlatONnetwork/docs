...
8. **activateWalletOp** 组装部署钱包的userOp
...
9. **calculateWalletAddress** 计算钱包地址 (create2 反事实地址)
...
10. **addOwnerWithThresholdOp** 添加钱包owner及更新多签阈值
...
17. **startSessionOp** 开启免多签session
...
18. **clearSessionOp** 关闭免多签session
...
21. **isEnabledModule** 校验某地址是否为有效module
...
22. **isEnabledModules** 校验一组地址是否为有效module
...
23. **getModulesPaginated** 分页返回module数组
...
28. **setFallbackHandlerOp** 设置钱包的拓展功能处理器
...
29. **getEntryPoint** 获取钱包的 EntryPoint 地址
...
30. **withdrawDepositOp** 提取钱包自身质押到 EtryPoint 中的垫付金额
...
31. **addDeposit** 钱包本身质押垫付款到 EntryPoint 
